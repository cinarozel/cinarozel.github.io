...
if($("body.optimize-svg-v4").length){$(window).scroll(function(){var c=document.documentElement.scrollTop||document.body.scrollTop;
if(c>150&&!b){a()
}})
}else{a()
}function a(){b=true;
$("head").append("<link>");
var c=$("head").children(":last");
c.attr({rel:"stylesheet",type:"text/css",href:"/etc/designs/huawei-cbg-site/clientlib-support-v2/support-public/css/slow-load-svg.css"})
}});
}

/*
     FILE ARCHIVED ON 22:16:42 Jul 31, 2021 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.009
  cdx.remote: 57.134
  LoadShardBlock: 286.941 (3)
  PetaboxLoader3.datanode: 503.298 (5)
  PetaboxLoader3.resolve: 820.564 (3)
  load_resource: 1118.715 (2)
*/