...
var LAG_MAP_ICO_URL="//web.archive.org/web/20210731221626/https://consumer-res.huawei.com/etc/designs/huawei-cbg-site/clientlib-support-v2/asset/img/servicenet/map/{index}.png";
...
}var haURLsJson={test:{url:"https://web.archive.org/web/20210731221626/https://cloudbackup.hwcloudtest.cn:6447/webv1"},China:{url:"https://web.archive.org/web/20210731221626/https://metrics-drcn.dt.hicloud.com/webv1",sites:{en:"",cn:""}},Russia:{url:"https://web.archive.org/web/20210731221626/https://metrics5.data.hicloud.com:6447/webv1",sites:{ru:""}},Europe:{url:"https://web.archive.org/web/20210731221626/https://metrics2.data.hicloud.com:6447/webv1",sites:{at:"",by:"",be:"",ba:"",br:"",bg:"",hr:"",cy:"",cz:"",dk:"",ee:"",fi:"",fr:"",de:"",gr:"",hu:"",ie:"",it:"",jp:"",kr:"",lv:"",lt:"",md:"",nl:"",mk:"",no:"",pl:"",pt:"",ro:"",rs:"",sk:"",si:"",es:"",se:"",ch:"",tr:"",ua:"",uk:"",us:"","us-es":"","ch-fr":"","md-ru":"","be-fr":"","lv-ru":""}},Singapore:{url:"https://web.archive.org/web/20210731221626/https://metrics-dra.dt.hicloud.com:6447/webv1",sites:{dz:"",ar:"",az:"",bd:"",bo:"",bw:"",kh:"",cm:"",ca:"","ca-fr":"",cl:"",co:"",cg:"",cr:"","do":"",ec:"",eg:"","eg-e":"","et-en":"",gh:"",gt:"",hk:"","in":"",id:"",ir:"","ir-fa":"",il:"",kz:"",ke:"",kw:"","kw-en":"",la:"",latin:"","latin-en":"",levant:"","levant-ar":"",my:"",mu:"",mx:"",ma:"",mm:"",np:"",nz:"",ng:"",pk:"",pa:"",py:"",pe:"",ph:"",sa:"","sa-en":"",sg:"",za:"",lk:"",tw:"",th:"",tg:"",tn:"",ae:"","ae-fa":"",uy:"",uz:"",vn:""}}};
...
v.repo=function(){var g="https://web.archive.org/web/20210731221626/http://consumer-res.huawei.com/etc/designs/huawei-cbg-site/statics/";
...
var k={type:"html5",src:"https://web.archive.org/web/20210731221626/https://consumer.huawei.com/en/ucmf/groups/public/documents/webasset/jwplayer_cej.html5.js"},b={type:"flash",src:g.base+"jwplayer.flash.swf"};
...
a.extend(b,c);
d.find(".select").on("click",function(l){if(f()){return
}var n=a(this),j=n.find("ol"),k=n.siblings(".select");
var h=j.find("li");
if((n.parents(".add-contact-info").length>0||n.parents(".user-perfect-dialog").length>0)&&h.length==0){return
}if(n.hasClass("disable")){return
}if(j.data("slide")=="open"){j.slideUp(250,function(){j.data("slide","close")
});
n.find("span").removeClass("active")
}else{j.slideDown(250,function(){j.data("slide","open")
});
n.find("span").addClass("active")
}k.find("ol").slideUp(250,function(){a(this).data("slide","close")
});
k.find("span").removeClass("active");
if(n.parents(".add-contact-info").length>0||n.parents(".user-perfect-dialog").length>0){var g=n.parents(".s-selector").siblings(".s-selector");
...
var f="";
switch(d){case"facebook":f="https://web.archive.org/web/20210731221626/https://www.facebook.com/sharer/sharer.php?u="+a;
break;
case"googleplus":f="https://web.archive.org/web/20210731221626/https://plus.google.com/u/0/share?text="+c+encodeURIComponent(" ")+a;
break;
case"twitter":f="https://web.archive.org/web/20210731221626/https://twitter.com/intent/tweet?text="+c+encodeURIComponent(" ")+a;
break;
case"sinablog":f="https://web.archive.org/web/20210731221626/http://v.t.sina.com.cn/share/share.php?url="+a+"&title="+c+"&appkey=330242870";
break;
case"qqblog":f="https://web.archive.org/web/20210731221626/http://shuqian.qq.com/post?from=3&title="+c+"&uri="+encodeURIComponent(document.location.href)+"&jumpback=2&noui=1";
break;
default:f=""
}window.open(f,d,"toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=800,height=500,location=1")
}var basesupport="//web.archive.org/web/20210731221626/https://consumer.huawei.com/support/services/";
...
d.src="//web.archive.org/web/20210731221626/https://maps.google.com/maps/api/js?key=AIzaSyB5ykZNED0-oT4i1RZRqS9oetClB7wCwfE&language="+c.toLowerCase()+"&callback=initMap";
...
/*
     FILE ARCHIVED ON 22:16:26 Jul 31, 2021 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.038
  cdx.remote: 59.433
  LoadShardBlock: 166.464 (3)
  PetaboxLoader3.datanode: 243.555 (5)
  load_resource: 1065.893 (2)
  PetaboxLoader3.resolve: 773.265 (2)
*/