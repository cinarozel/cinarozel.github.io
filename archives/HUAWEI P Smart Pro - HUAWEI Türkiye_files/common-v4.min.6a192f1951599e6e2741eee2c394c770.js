...
return
}sgwHost="https://web.archive.org/web/20210731221641/https://sgw-cn.c.huawei.com/forward"
}}catch(b){}}initSgw();
...
if(window.innerWidth<e.uiBoundaryVal){if(a.is(":visible")){a.slideUp(400)
...
if(window.innerWidth<e.uiBoundaryVal){if(e.$ipJump.length>0){$(".platform-selection-mob").removeAttr("style")
}}}}})
...
var n01MainNavigation={$selector:$(".n01-main-navigation"),$mainNav:$(".main-nav"),mainNavOpenedClass:"main-nav--opened",mainNavItem:".main-nav__item",mainNavItemVisibleClass:"main-nav__item--visible",navLink:".main-nav__link",navLinkOpenedClass:"main-nav__link--opened",navLinkTransparentClass:"main-nav__link--transparent",searchOpenBtn:".js-open-search",searchPopup:".n12-search",openedSearch:false,$loginV4:$(".login-v4-wrap"),$loginV4OpenedClass:"active",$ipJump:$(".ip-jump-wrap"),popup:".popup",popupCloseBtn:".js-close-popup",popupVisibleClass:"popup--visible",header:".header",popupOpenedClass:"header--popup-opened",popupOpenedTimer:null,isPopupOpened:false,$navToggle:$(".js-nav-toggle"),navToggleActiveClass:"nav-toggle--active",$platformToggle:$(".js-platform-toggle"),$platformModule:$(".platform-selection"),$platformContent:$(".platform-selection__content"),platformToggleVisibleClass:"platform-selection__toggle--visible",platformToggleOpenedClass:"platform-selection__toggle--opened",platformToggleDisabledClass:"platform-selection__toggle--disabled",navVersion:$("#header-v4 #mainNav").val()||"nav-v1",uiBoundaryVal:1200,pcLfNavW:0,pcRgNavW:0,pcAddonsW:0,otherAreaW:0,topScroll:0,isScrollDisabled:false,scrollTimer:null,pageTypeNavFlag:false,init:function(){var a=this;
a.uiBoundaryVal=a.navVersion=="nav-v1"?1200:1366;
...
this.bindIpJump()
}},calcNewUIBoundaryVal:function(){var b=Mkt.Util.pageWidth();
if(this.navVersion=="nav-v2"&&b>1365){var d=$(".v4.n01-main-navigation.nav-v2 .main-nav .lf-nav");
var c=$(".v4.n01-main-navigation.nav-v2 .main-nav .rg-nav");
this.pcLfNavW=Math.round(d.width());
this.pcRgNavW=Math.round(c.width());
var e=$(".v4.n01-main-navigation.nav-v2 .nav-addons");
this.pcAddonsW=Math.round(e.width());
var f=80;
if(b<1600&&b>=768){f=40
}var a=110+64+40;
this.uiBoundaryVal=this.pcLfNavW+this.pcRgNavW+this.pcAddonsW+a+f*2;
this.otherAreaW=this.pcAddonsW+a+f*2
}},calcMainNavWidth:function(){if(this.navVersion=="nav-v2"){var a=Mkt.Util.pageWidth();
var b=Mkt.Util.windowWidth();
a=a>=b?b-17:a;
if(a>1365){if(a<this.uiBoundaryVal){$("#header-v4,#header-placeholder").addClass("mb-ui");
$(".v4.n01-main-navigation.nav-v2 .main-nav").width("100%")
}else{var c=a-this.otherAreaW;
$(".v4.n01-main-navigation.nav-v2 .main-nav").width(c);
...
$(this.navLink).hover(function(){if(!a.isPopupOpened&&window.innerWidth>=a.uiBoundaryVal){if(a.navVersion=="nav-v1"){$(this).parent().siblings().find(a.navLink).addClass(a.navLinkTransparentClass)
}}},function(){if(!a.isPopupOpened&&window.innerWidth>=a.uiBoundaryVal){$(this).addClass("unhover");
a.$mainNav.find("."+a.navLinkTransparentClass).removeClass(a.navLinkTransparentClass)
}})
},bindNavLinkClick:function(){var a=this;
$(document).on("click",a.navLink,function(d){var b=$(this);
var c=b.siblings(a.popup);
clearTimeout(a.popupOpenedTimer);
a.openedSearch=false;
c.find("img.lazyload-img").each(function(){$(this).attr("src",$(this).attr("data-src")).removeClass("lazyload-img")
});
if(window.innerWidth>=a.uiBoundaryVal){if(a.pageTypeNavFlag){if($("#header-v4").hasClass("minisite-nav")){$("#header-v4").toggleClass("minisite-nav")
...
}}if(c.length){if(window.innerWidth>=a.uiBoundaryVal){if(b.hasClass(a.navLinkOpenedClass)){b.removeClass(a.navLinkOpenedClass);
c.removeClass(a.popupVisibleClass);
...
c.addClass(a.popupVisibleClass);
if(a.navVersion=="nav-v1"){b.parent().siblings().find(a.navLink).addClass(a.navLinkTransparentClass)
...
a.openedSearch=true;
if(window.innerWidth>=a.uiBoundaryVal){a.unScroll()
}a.disableScroll();
...
a.removeUnScroll();
a.enableScroll()
}if(window.innerWidth>=a.uiBoundaryVal){a.$platformToggle.removeClass(a.platformToggleOpenedClass).addClass(a.platformToggleDisabledClass);
a.$platformContent.stop().slideUp(200)
...
}if(window.innerWidth<a.uiBoundaryVal){if(a.$loginV4.hasClass(a.$loginV4OpenedClass)){$(a.$loginV4).removeClass(a.$loginV4OpenedClass)
}}}})
...
}if(!a){this.isPopupOpened=false;
var c=$("."+this.navLinkTransparentClass);
...
if($(this).hasClass(a.navToggleActiveClass)){if(window.innerWidth<a.uiBoundaryVal){a.$mainNav.find(a.mainNavItem).each(function(c){var b=$(this);
...
var a="";
if(window.innerWidth>=b.uiBoundaryVal){if(isECommerceSite=="Fusion-eCommerce"){b.$loginV4.bind("click",function(c){c.stopPropagation();
...
if(window.innerWidth>=c.uiBoundaryVal){a.css("top",b+"px")
}if(window.innerWidth<c.uiBoundaryVal){if($("#locationSecret").is(":visible")){var b=$("#header-v4").innerHeight();
c.$mainNav.css("top",b+"px")
}else{c.$mainNav.css("top",b+"px")
}}}else{if(window.innerWidth<c.uiBoundaryVal){if($("#locationSecret").is(":visible")){var b=$("#header-v4").innerHeight();
c.$mainNav.css("top",b+"px")
...
if(window.innerWidth>=a.uiBoundaryVal&&!this.$selector.hasClass("list-navigation")){if(typeof window.onmousewheel=="object"){window.addEventListener("mousewheel",a.stopScroll,{passive:false});
...
if(window.innerWidth>=a.uiBoundaryVal){$(window).off("scroll",a.scrollClosePopups);
...
if(window.innerWidth<a.uiBoundaryVal&&window.window.pageCategory=="support"){$(".nav-addons .nav-toggle").click(function(){$($(".main-nav .is-support-menu").find("a")[0]).click()
})
...
$(window).on("load resize",function(){n01MainNavigation.calcMainNavWidth();
n01MainNavigation.customScrollBarProducts();
n01MainNavigation.bindIpJump()
});
var n02ExpandedProducts={$selector:$(".n02-expanded-products"),navVersion:$("#header-v4 #mainNav").val()||"nav-v1",uiBoundaryVal:1200,init:function(){var a=this;
a.uiBoundaryVal=a.navVersion=="nav-v1"?1200:1366;
if(a.$selector.length){a.imageDimension()
...
if($(window).width()>a.uiBoundaryVal){a.$selector.each(function(){var d=$(this).find(".dropdown__holder--two-img");
...
}if($(window).width()>=a.uiBoundaryVal){a.mobileServicesbg(".one-two-icon .pc-bg")
}},mobileServicesbg:function(a){$(a).each(function(c,d){var b=$(this).attr("pc-bg");
...
var n09Footer={$selector:$(".n09-footer"),$scrollTopBtn:$(".js-scroll-top"),uspList:".usp-list",$footerAccordionBtn:$(".js-footer-accordion-btn"),$lanChangeSelector:$(".language-switcher"),init:function(){if(this.$selector.length){this.bindScrollTopClick();
...
this.lazyLoadImg();
var a=this;
$(window).on("scroll",function(){a.lazyLoadImg()
});
...
},lazyLoadImg:function(){this.$selector.find(".lazyload-target:in-viewport").each(function(){var a=$(this);
a.find(".lazyload-img").each(function(){var b=$(this);
if(b.is("img")){b.attr("src",b.attr("data-src"));
a.removeClass("lazyload-target")
}else{if(b.is("source")){b.attr("srcset",b.attr("data-srcset"));
a.removeClass("lazyload-target")
}}})
})
}};
...
var API_HOST=(location.href.indexOf(".test.huawei.com")==-1&&location.href.indexOf("localhost")==-1)?"https://web.archive.org/web/20210731221641/https://consumer.huawei.com/cmkt":supportv2.cmktApiUrl;
...
b.Util.callAEMServletBySelector(c,false).then(function(k){sessionStorage.setItem(g+e.getLocale(),JSON.stringify(k));
j=k;
h()
})
};
...
e.patchText=function(m,l){if(l||l=="0"){if(a.isArray(l)){for(var k=0;
k<l.length;
k++){m=m.replace("{"+k+"}",l[k])
...
}}function price_show(i,j,k,c,f,p){var m="";
var o="";
var n=showFrom&&p.data("onepricedisplay")!==true;
var d=n?'<span class="text-from"> '+PlpI18n.i18n_from+" </span>":"";
if(n){if(putFromFront){m=d
}else{o=d
}}var r={};
if(j&&k){r.minOrderPrice=j.minOrderPrice?j.minOrderPrice:k.minOrderPrice;
r.minUnitPrice=j.minUnitPrice?j.minUnitPrice:k.minUnitPrice
}else{r.minOrderPrice=currentRes.minOrderPrice;
r.minUnitPrice=currentRes.minUnitPrice
}if(c){if(j){r.hasStaging=j.hasStaging?j.hasStaging:hasStaging
}else{r.hasStaging=hasStaging
}var b=window.innerWidth>=1024?"PC":"mobile",a="",l="";
if(window.siteCode==="uk"||window.siteCode==="de"||window.siteCode==="es"){a=ecCom.I18n.get("ec_finance_available")
}else{if(window.siteCode==="ru"){a=ecCom.I18n.get("ec_payment_in_installments",[r.hasStaging.amount])
}else{if(window.siteCode==="ro"){a=ecCom.I18n.get("ec_bank_installment")
}else{a=ecCom.I18n.get("ec_payment_in_installments",[r.hasStaging.num])
}}}l=ecCom.I18n.get("ec_installment_or")+" "+a;
var h="";
var q="";
if(enableRRP){h='<span style="color: #bebebe;font-size: 13px;font-weight: normal;">'+RRPText+"</span>";
q="text-decoration:none;"
}var g=r.minUnitPrice!=r.minOrderPrice?'<b class="plp-item-price"><ul class="proPrice"><li class="salePrice">'+m+"<span >"+window.ecCurrency(r.minUnitPrice)+" </span>"+o+'</li><li class="amountPrice"><span >'+l+'</span></li><li class="minorderprice" style='+q+">"+h+'<span class="plp-item-minorderprice" style="margin-left: 0;text-decoration:line-through;">'+m+" "+window.ecCurrency(r.minOrderPrice)+" "+o+"</span></li></ul></b>":'<b class="plp-item-price"><ul class="proPrice"><li class="minorderprice"><span class="plp-item-minorderprice"></span></li><li class="salePrice">'+m+"<span >"+window.ecCurrency(r.minUnitPrice)+" </span>"+o+'</li><li class="amountPrice"><span >'+l+"</span></li></ul></b>"
}else{var h="";
if(enableRRP){h='<span style="color: #bebebe;font-size: 13px;font-weight: normal;">'+RRPText+"</span>"
}g=r.minUnitPrice!=r.minOrderPrice?'<b class="plp-item-price"><ul class="proPrice"><div class="inShow"><li class="salePrice">'+m+"<span >"+window.ecCurrency(r.minUnitPrice)+"</span>"+o+'</li><li class="minorderPrice" >'+h+'<span class="plp-item-minorderprice">'+m+" "+window.ecCurrency(r.minOrderPrice)+" "+o+"</span></li></div></ul></b>":'<b class="plp-item-price"><ul class="proPrice"><div class="inShow"><li class="minorderPrice" ><span ></span></li><li class="salePrice">'+m+"<span >"+window.ecCurrency(r.minUnitPrice)+"</span>"+o+"</li></div></ul></b>"
}if(i){i.find(".plp-item-fromprice").html(g)
...
/*
     FILE ARCHIVED ON 22:16:41 Jul 31, 2021 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:21:22 Mar 05, 2026.
...
playback timings (ms):
  ...
  esindex: 0.013
  cdx.remote: 200.895
  LoadShardBlock: 141.718 (3)
  PetaboxLoader3.datanode: 440.156 (5)
  load_resource: 1151.813 (2)
  PetaboxLoader3.resolve: 731.859 (2)
*/